...
class Image(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    time_uploaded = models.DateTimeField("time uploaded", default=datetime.now)
...
class Report(models.Model):
    ...
    time_published = models.DateTimeField("time published", default=datetime.now)
...
class Rating(models.Model):
    ...
    def __str__(self) -> str:
        return f"Rating: {'Positive' if self.is_positive else 'Negative'}"
